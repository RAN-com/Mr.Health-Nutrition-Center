...
import backgroundImage from '../../../../public/Asset1@4x1.png'; // Correct image path
...
const Bmi = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-green-600 p-2 ">
        ...
        <div className="bg-transparent p-4 rounded-lg shadow-md">
          <div className="min-h-screen p-4 flex flex-col md:flex-row">
            ...
            <div className="md:w-1/3 p-4">
              <h2 className="text-xl font-bold mb-4 text-white">BMI & BMR Calculator</h2>
            ...
            <div className="md:w-1/3 p-4">
              ...
              <div className="bg-gray-100 p-4 rounded-lg shadow-md">
                {bmi !== null ? (
                  ...
                  <p className="text-lg text-center text-white">No BMI result yet.</p>
                )}
                {bmr !== null ? (
                  <p className="text-lg mt-4">Your BMR is <strong>{bmr}</strong> kcal/day.</p>
                ) : (
                  <p className="text-lg text-center text-white">No BMR result yet.</p>
                )}
              </div>
            </div>
          </div>
