...
const Home = () => {
  ...
  <div className="relative h-screen">
    <div
      ...
      style={bgImageStyle} // Ensure bgImageStyle is defined
    ></div>
    <div className="absolute inset-0 m-6 md:m-24 flex flex-col justify-center text-white p-6">
      <h1 className="text-4xl md:text-6xl font-bold mb-4">
        {imageSlide[currentState].title}
      </h1>
      <p className="text-lg md:text-4xl font-bold mb-6">
        {imageSlide[currentState].body}
      </p>
      <button
        onClick={openPopup}
        className="bg-white items-center w-72 h-auto text-green-400 font-bold py-2 px-4 rounded hover:bg-gray-200 transition-colors"
      >
    ...
    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
      ...
      <header className="App-header p-5 justify-center items-center text-center bg-yellow-400">
        <h1 className="text-4xl font-bold mb-4 text-white">Photo</h1>
        <Main />
      </header>

      <header className="App-header p-1 justify-center items-center text-center bg-yellow-400">
      ...
      <section className="bg-green-600">
        <div className="flex justify-between p-5 gap-[50px] lg:gap-0">
